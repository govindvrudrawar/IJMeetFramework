...
public class Keyword {
	...
	public static void launchBrowser(String browserName) {
		 ...
		 * @param:Accepts String url as a parameter which needs to be launched 
		 * url should be in format https://www.applicationname.com
		 */
		...
		*/
		...
		/*
		 * This method will delete the cookies 
		 */
		 ...
		 * @param:Accepts WebElement as a parameter over which we need to hover the mouse 
		 * 
		 */
		...
		/*This method will fetch the WebElement for which we have passed the locator type and locator value
		...
		/*
		 * This is a overloaded method for fetching the WebElement directly from the POM Classes
		 * Will have to use the Object Reference of the respective class to fetch from the POM Class
		...
		/*This method will fetch us the List of WebElement for which we have passed the locator type and locator value
		...
		/*This method accepts WebElement Name which we have fetched in our POM Class and returns List of WebElements 
	...
	/*
	 * This method will fetch us the text for the WebElement which is passed as parameter 
	...
	/*This method will enter the text in the location which is passed as an argument
	 * @Param:Accepts WebElement as an argument i.e. the Text Box/Text Field in which we need to pass the text 
	 ...
	 */
		...
		/*This method captures screenshot for the viewport using Yandex AShot library and returns the Image 
		 * @Param:Accepts parameter the file-format in which we need the output Image
		 * @Param:Accepts parameter as the location in which we want to save the screenshot taken
		 */
		 ...
		 * @Param:Accepts int value as parameter i.e. the time in milliseconds for which the web-page will be parsed  
		 * @Param:Accepts parameter as the type of Image we want i.e. JPG or PNG
		 * @Param:Accepts paramter as the location where we need to save the image output stream 
		 */
		public static Screenshot captureFullScreenshot(int timeinMiliseconds, String formatName, FileOutputStream filepath) throws IOException {
			
			ashot = new AShot();
			Screenshot sc=ashot.shootingStrategy(ShootingStrategies.viewportPasting(timeinMiliseconds)).takeScreenshot(driver);
		...
		/*This method will capture the screenshot for the WebElement of our interest and which needs to be passed as a parameter
		 * @Param:Accepts WebElement as a parameter for which we want the screenshot
		 * @Param:Accepts Image format as a parameter the type of format which we want the image to be of
		 * @Param:Accepts the parameter as location where we want our FileOutPut Stream to be stored at
		 */
		public static Screenshot captureWebElementScreenshot(WebElement element, String formatName, FileOutputStream filepath) throws IOException {
		...
		/*
		 * This method will fetch the exact Y location (vertical location on the Webpage for the stated WebElement)
		 * @Param:Accepts parameter as WebElement as an argument for which we want the Y Location
		 */
		...
		/*This method will fetch the exact X location (the horizontal location on the Webpage for the stated WebElement)
		 * @Param:Accepts paramter as WebElement for which we want the exact X location
		 * @returns:The int X location (The horizontal location which we need for the WebElement of our interest ) 
		 */
		...
		/*
		 * This method will scroll the window by the length which is passed 
		 * To scroll the WebPage vertically give i = 0; 
		 * @Param:Takes argument as int values i.e. the length value by which we will scroll the WebPage
		 * To
		 */
		...
		/*
		 * This method will close the current window to which the driver instance is pointing to
		 */
